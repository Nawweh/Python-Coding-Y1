...
def game_scrabble():
    ...
    for i in range(6):
        ...
        print(f"\n make a word using some or all of the characters in this string: ")
        while valid!=True:
            word=input()
            for letter in word:
                for x in range (0,7):
    ...
    if p1_score>p2_score:
        print(f"p1 wins with a score of {p1_score} to {p2_score}")
    else:
        print(f"p2 wins with a score of {p2_score} to {p1_score}")
