...
def get_region():
    ...
    while flag:
        ...
        try:
            ...
            if int(userRegion) < 1 or int(userRegion) >  13:
                print("----------------")
    ...
    while flag:
        ...
        try:
            ...
            if float(weight) < 0:
                ...
                print("Sorry, the number can't be 0")
                flag = True
            else:
                return float(weight)
...
def calc_additional_charge(collect, deliver):
    ...
    if collect == "Northern Ireland" and deliver == "Northern Ireland":
        additionalCharge = 0
    else:
        additionalCharge = 0
...
def main():
    ...
    for i in range(numParcels):
        ...
        additionalCharge = round(additionalCharge,2)
    ...
    print("Total Parcel weight", totalWeight)
